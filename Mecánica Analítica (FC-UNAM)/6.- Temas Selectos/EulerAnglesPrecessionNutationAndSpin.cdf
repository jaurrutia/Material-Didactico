...
NotebookDataLength[     83193,       1655]
NotebookOptionsPosition[     56863,       1086]
NotebookOutlinePosition[     83137,       1647]
CellTagsIndexPosition[     83026,       1641]
WindowTitle->Euler Angles: Precession, Nutation, and Spin
WindowFrame->Normal*)
...
Cell["Euler Angles: Precession, Nutation, and Spin", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`a1$$ = 0, $CellContext`a2$$ = 
    0, $CellContext`a3$$ = 0, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {
    "\"pos0\"" :> {$CellContext`a1$$ = 0, $CellContext`a2$$ = 
       0, $CellContext`a3$$ = 0}, 
     "\"pos1\"" :> {$CellContext`a1$$ = 45, $CellContext`a2$$ = 
       0, $CellContext`a3$$ = 0}, 
     "\"pos2\"" :> {$CellContext`a1$$ = 45, $CellContext`a2$$ = 
       30, $CellContext`a3$$ = 0}, 
     "\"pos3\"" :> {$CellContext`a1$$ = 45, $CellContext`a2$$ = 
       30, $CellContext`a3$$ = 15}, 
     "\"pos4\"" :> {$CellContext`a1$$ = 0, $CellContext`a2$$ = 
       30, $CellContext`a3$$ = 15}, 
     "\"pos5\"" :> {$CellContext`a1$$ = 0, $CellContext`a2$$ = 
       0, $CellContext`a3$$ = 15}, 
     "\"pos6\"" :> {$CellContext`a1$$ = 0, $CellContext`a2$$ = 
       0, $CellContext`a3$$ = 0}}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`a1$$], 0, "precession angle"}, 0, 360, 1}, {{
       Hold[$CellContext`a2$$], 0, "nutation angle"}, 0, 360, 1}, {{
       Hold[$CellContext`a3$$], 0, "spin angle"}, 0, 360, 1}}, 
    Typeset`size$$ = {400., {198., 202.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`a1$16681$$ = 0, $CellContext`a2$16682$$ = 
    0, $CellContext`a3$16683$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`a1$$ = 0, $CellContext`a2$$ = 
        0, $CellContext`a3$$ = 0}, "ControllerVariables" :> {
        Hold[$CellContext`a1$$, $CellContext`a1$16681$$, 0], 
        Hold[$CellContext`a2$$, $CellContext`a2$16682$$, 0], 
        Hold[$CellContext`a3$$, $CellContext`a3$16683$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`s1$, $CellContext`s2$, $CellContext`s3$, \
$CellContext`gimbal$, $CellContext`c3r$, $CellContext`rotorr$}, \
$CellContext`s1$ = ($CellContext`a1$$/1) 
          Degree; $CellContext`s2$ = ($CellContext`a2$$/1) 
          Degree; $CellContext`s3$ = ($CellContext`a3$$/1) 
          Degree; $CellContext`gimbal$ = 
         Rotate[{$CellContext`c2, $CellContext`c3r$, $CellContext`ax2a, \
$CellContext`ax2b, $CellContext`axis1}, $CellContext`s1$, {0, 0, 
           1}]; $CellContext`c3r$ = 
         Rotate[{$CellContext`c3, $CellContext`rotorr$, $CellContext`ax3a, \
$CellContext`ax3b, $CellContext`axis2}, $CellContext`s2$, {0, 1, 
           0}]; $CellContext`rotorr$ = 
         Rotate[{$CellContext`rotor, $CellContext`axis3}, $CellContext`s3$, {
           0, 0, 1}]; 
        Graphics3D[{$CellContext`c1, $CellContext`gimbal$, $CellContext`axis, \
$CellContext`ax1a, $CellContext`ax1b}, ViewAngle -> Pi/8, PlotRange -> 
          35 {{-1, 1}, {-1, 1}, {-1, 1}}, ViewPoint -> 0.35 {6, 1, 2}, 
          ViewVertical -> $CellContext`z, SphericalRegion -> True, Boxed -> 
          False, ImageSize -> {400, 400}]], 
      "Specifications" :> {{{$CellContext`a1$$, 0, "precession angle"}, 0, 
         360, 1, Appearance -> 
         "Labeled"}, {{$CellContext`a2$$, 0, "nutation angle"}, 0, 360, 1, 
         Appearance -> "Labeled"}, {{$CellContext`a3$$, 0, "spin angle"}, 0, 
         360, 1, Appearance -> "Labeled"}}, 
      "Options" :> {
       TrackedSymbols :> {$CellContext`a1$$, $CellContext`a2$$, \
$CellContext`a3$$}, InterpolationOrder -> 1}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{445., {269., 274.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(((($CellContext`o = {0, 0, 0}; $CellContext`x = {1, 0, 
          0}; $CellContext`y = {0, 1, 0}; $CellContext`z = {0, 0, 
          1}; $CellContext`la = 25; Null); $CellContext`lt = 27; 
       Null); $CellContext`blank = "    "; $CellContext`c1 = Part[
         ParametricPlot3D[{
           Sin[$CellContext`u], (16 + Cos[$CellContext`u]) 
           Cos[$CellContext`v], (16 + Cos[$CellContext`u]) 
           Sin[$CellContext`v]}, {$CellContext`u, 0, 2 Pi}, {$CellContext`v, 
           0, 2 Pi}, Mesh -> None, PlotStyle -> {
            RGBColor[1, 1, 0.4]}, PlotPoints -> 50], 1]; $CellContext`c2 = 
       Part[
         ParametricPlot3D[{
           Sin[$CellContext`u], (12 + Cos[$CellContext`u]) 
           Cos[$CellContext`v], (12 + Cos[$CellContext`u]) 
           Sin[$CellContext`v]}, {$CellContext`u, 0, 2 Pi}, {$CellContext`v, 
           0, 2 Pi}, Mesh -> None, PlotStyle -> {
            RGBColor[0.6, 0.8, 1]}, PlotPoints -> 50], 1]; $CellContext`c3 = 
       Part[
         ParametricPlot3D[{
           Sin[$CellContext`u], (8 + Cos[$CellContext`u]) 
           Cos[$CellContext`v], (8 + Cos[$CellContext`u]) 
           Sin[$CellContext`v]}, {$CellContext`u, 0, 2 Pi}, {$CellContext`v, 
           0, 2 Pi}, Mesh -> None, PlotStyle -> {
            RGBColor[1, 0.6, 0.4]}, PlotPoints -> 50], 1]; $CellContext`rotor = {
         RGBColor[0.8, 1, 0.2], 
         Cylinder[{{0, 0, -1}, {0, 0, 1}}, 5], 
         Cuboid[3 {-1, -1, -1}, 3 {1, 1, 1}]}; $CellContext`ax1a = {
         RGBColor[1, 1, 0.4], 
         Cylinder[{{0, 0, 10.7}, {0, 0, 17.4}}, 0.5]}; $CellContext`ax1b = {
         RGBColor[1, 1, 0.4], 
         Cylinder[{{0, 0, -10.7}, {0, 0, -17.4}}, 0.5]}; $CellContext`ax2a = {
        Blue, 
         Cylinder[{{0, 6.7, 0}, {0, 13.4, 0}}, 0.5]}; $CellContext`ax2b = {
        Blue, 
         Cylinder[{{0, -6.7, 0}, {0, -13.4, 0}}, 0.5]}; $CellContext`ax3a = {
        Red, 
         Cylinder[{{0, 0, 1}, {0, 0, 9.4}}, 0.3]}; $CellContext`ax3b = {Red, 
         Cylinder[{{0, 0, -1}, {0, 0, -9.4}}, 0.3]}; $CellContext`axis = {
        Black, Thick, 
         Line[{$CellContext`o, $CellContext`la $CellContext`x}], 
         Line[{$CellContext`o, $CellContext`la $CellContext`y}], 
         Line[{$CellContext`o, $CellContext`la $CellContext`z}], 
         Text[
          Style["X", Italic], $CellContext`lt $CellContext`x], 
         Text[
          Style["Y", Italic], $CellContext`lt $CellContext`y], 
         Text[
          Style[
          "Z", Italic], $CellContext`lt $CellContext`z]}; $CellContext`axis1 = \
{Blue, Thick, 
         Line[{$CellContext`o, $CellContext`la $CellContext`x}], 
         Line[{$CellContext`o, $CellContext`la $CellContext`y}], 
         Line[{$CellContext`o, $CellContext`la $CellContext`z}], 
         ...
         Text[
          Style["y", Italic], $CellContext`lt $CellContext`y], 
         Text[
          Row[{$CellContext`blank, 
            Style[
            "z", Italic]}], $CellContext`lt $CellContext`z]}; \
$CellContext`axis2 = {Red, Thick, 
         Line[{$CellContext`o, $CellContext`la $CellContext`x}], 
         Line[{$CellContext`o, $CellContext`la $CellContext`y}], 
         Line[{$CellContext`o, $CellContext`la $CellContext`z}], 
         Text[
         ...
         Text[
          Style[
          "z", Italic], $CellContext`lt $CellContext`z]}; $CellContext`axis3 = {
         RGBColor[0.4, 0.5, 0.1], Thick, 
         Line[{$CellContext`o, $CellContext`la $CellContext`x}], 
         Line[{$CellContext`o, $CellContext`la $CellContext`y}], 
         Line[{$CellContext`o, $CellContext`la $CellContext`z}], 
         Text[
         ...
         Text[
          Row[{$CellContext`blank, 
            Style["z", Italic]}], $CellContext`lt $CellContext`z]}; Null); 
...
Cell[TextData[{
 "Here a gyroscope is used to illustrate the Euler angles in a 3-2-3 \
rotation. The outer ring is fixed in space. The angles are generally \
designated ",
 Cell[BoxData[
...
Cell[TextData[{
 ButtonBox["Euler Angles",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/EulerAngles.html"], None},
  ButtonNote->"http://mathworld.wolfram.com/EulerAngles.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Gyroscope",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/Gyroscope/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/Gyroscope/"],
 " (",
...
EulerAnglesPrecessionNutationAndSpin&version=0008"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/EulerAnglesPrecessionNutationAndSpin/\
EulerAnglesPrecessionNutationAndSpin-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\[NonBreakingSpace]",
 ButtonBox["Kevin Hernandez",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Kevin+\
Hernandez"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Kevin+Hernandez"]
}], "Author",
 FontColor->GrayLevel[0.6]],

Cell[TextData[{
 "\"",
 ButtonBox["Euler Angles: Precession, Nutation, and Spin",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
EulerAnglesPrecessionNutationAndSpin/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/EulerAnglesPrecessionNutationAndSpin/"],
 "\"",
 "\[ParagraphSeparator]\[NonBreakingSpace]",
 ButtonBox["http://demonstrations.wolfram.com/\
EulerAnglesPrecessionNutationAndSpin/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
EulerAnglesPrecessionNutationAndSpin/"], None},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[44685, 792, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[44946, 801, 3713, 82, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[56041, 1061, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 82739, 1630},
 {"Copyright", 82934, 1635}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[35692, 602, 8328, 164, 70, "Output",
 CellID->797730194],
Cell[44023, 768, 659, 22, 70, "ManipulateCaption"],
Cell[44685, 792, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[44946, 801, 3713, 82, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[48662, 885, 44, 0, 70, "RelatedLinksSection"],
Cell[48709, 887, 626, 21, 70, "RelatedLinks",
 CellID->344680537],
Cell[49338, 910, 452, 14, 70, "RelatedLinks",
 CellID->27928394],
Cell[49793, 926, 4847, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[54643, 1017, 45, 0, 70, "CitationSection"],
Cell[54691, 1019, 333, 10, 70, "Author"],
Cell[55027, 1031, 1011, 28, 70, "Citations"],
Cell[56041, 1061, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature SQEOLuMLPznRbwm#JopUxZTa *)
